        ...
        <div class="container header-container">
            ...
            <div class="site-branding">
                <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" class="logo-link">
                    <!-- SVG Logo -->
                    <svg class="site-logo-icon" width="40" height="40" viewBox="0 0 100 100" fill="none"
                ...
                <?php if (is_user_logged_in()):
                    ...
                    <div class="user-avatar-wrap" id="user-avatar-wrap">
                        <img src="<?php echo esc_url($avatar_url); ?>"
                            alt="<?php echo esc_attr($current_user->display_name); ?>" class="user-avatar-img">
                        ...
                        <div class="user-dropdown">
                            ...
                            <a href="<?php echo esc_url(home_url('/payroll-deduction/')); ?>"
                                class="user-dropdown-item">
                                <i class="bi bi-file-earmark-text"></i> Payroll Deduction Form
                            </a>
                            <a href="<?php echo esc_url(home_url('/sst-request-for-donation/')); ?>"
                                class="user-dropdown-item">
